...
partial class MappingCollection<T> : IList<T>, System.Collections.IList, IReadOnlyList<T>
{
    ...
    {
        if (_size - index < count)
            throw new ArgumentOutOfRangeException("Index and count are not suitable to a collection of size " + _size.ToString());
        Contract.EndContractBlock();
    ...
    public struct Enumerator : IEnumerator<T>, System.Collections.IEnumerator
    {
        ...
        private bool MoveNextRare()
        {
            ...
            {
                ThrowHelper.ThrowInvalidOperationExceptionEnumFailedVersion();
            }
        ...
        Object System.Collections.IEnumerator.Current
        {
            get
            {
                ...
                {
                    ThrowHelper.ThrowInvalidOperationExceptionInvalidState();
                }
                return Current;
            }
        }
