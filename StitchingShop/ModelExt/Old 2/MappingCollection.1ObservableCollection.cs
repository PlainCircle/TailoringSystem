...
[Serializable()]
#endif
partial class MappingCollection<TSourceItem, TSelectedItem> : INotifyCollectionChanged, INotifyPropertyChanged
{
    /// <summary>
    /// Initializes a new instance of the MappingCollection class
    /// that used the given datasource as internal source.
    /// </summary>
    /// <param name="list">The list that works as internal source.</param>
    /// <exception cref="ArgumentNullException"> list is a null reference </exception>
#if !FEATURE_CORECLR
    [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
#endif
    protected MappingCollection(IList<MappingItem<TSelectedItem>> list)
    {
        if (list == null)
        {
            throw new NullReferenceException("list can't be null.");
        }
        items = list;
    }
    ...
    [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
#endif
    protected virtual void InsertItem(int index, MappingItem<TSelectedItem> item)
    {
        if (_isReadOnly)
        {
        ...
        if (item==null)
        {
            throw new NullReferenceException("Can;t insert null item.");
        }
        CheckReentrancy();
    ...
    protected bool _isFixedSize = false;
    void InsertCore(int index, MappingItem<TSelectedItem> item)
    {
        // Note that insertions at the end are legal.
        if ((uint)index > (uint)_size)
        {
            throw new IndexOutOfRangeException("Insertions at the end are legal but you can't leave bank index at the end.");
        }
